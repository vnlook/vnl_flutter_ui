...
mixin AnimatedMixin on TickerProviderStateMixin {
  ...
  ///
  /// ```dart
  /// final bgColor = createAnimatedColor(VNLColors.red);
  /// bgColor.value = VNLColors.blue; // Will smoothly transition from red to blue
  /// ```
...
class TimelineAnimation<T> extends Animatable<T> {
  ...
  ///   keyframes: [
  ///     AbsoluteKeyframe(Duration(milliseconds: 300), VNLColors.red, VNLColors.blue),
  ///     RelativeKeyframe(Duration(milliseconds: 200), VNLColors.green),
  ///   ],
  /// );
  /// ```
  ...
  ///
  /// ```dart
  /// // VNLTimeline with natural duration of 500ms
  /// final timeline = TimelineAnimation<double>(...);
  ///
  /// // Scale to 2 seconds
