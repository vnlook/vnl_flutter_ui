...
///   (e.g., VNLCard, VNLAlertDialog, ListView panels)
/// - **Content padding**: Used for widgets that contain content
///   (e.g., VNLButton, VNLTextField, VNLChip)
///
/// Example:
/// ```dart
...
class Density {
  ...
  /// Base padding for container widgets (VNLCard, VNLAlertDialog, etc.).
...
///   spacing: padSm,
///   children: [
///     VNLChip(label: Text('Tag 1')),
///     VNLChip(label: Text('Tag 2')),
///   ],
/// )
/// ```
