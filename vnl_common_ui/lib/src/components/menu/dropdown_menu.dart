...
/// For most use cases, prefer using [VNLDropdownMenu] or similar widgets.
///
/// Key Features:
...
///   context: context,
///   builder: (context) => VNLDropdownMenu(
///     children: [
///       VNLMenuItem(title: Text('Option 1'), onTap: () => Navigator.pop(context, 'opt1')),
///       VNLMenuItem(title: Text('Option 2'), onTap: () => Navigator.pop(context, 'opt2')),
///     ],
///   ),
/// );
...
class VNLDropdownMenuData {
  ...
  VNLDropdownMenuData(this.key);
}

/// Theme for [VNLDropdownMenu].
class VNLDropdownMenuTheme extends ComponentThemeData {
  ...
  const VNLDropdownMenuTheme({this.surfaceOpacity, this.surfaceBlur});

  /// Returns a copy of this theme with the given fields replaced.
  VNLDropdownMenuTheme copyWith({
    ValueGetter<double?>? surfaceOpacity,
    ValueGetter<double?>? surfaceBlur,
  }) {
    return VNLDropdownMenuTheme(
      surfaceOpacity:
  ...
  bool operator ==(Object other) {
    ...
    return other is VNLDropdownMenuTheme &&
...
/// and theme integration. Wraps menu items in a [VNLMenuPopup] container with
...
/// button implementations. Menu items are provided as [VNLMenuItem] widgets.
///
/// Example:
/// ```dart
/// VNLDropdownMenu(
...
///
/// See also:
/// - [VNLMenuItem] for individual menu items
/// - [VNLMenuPopup] for the popup container
...
class VNLDropdownMenu extends StatefulWidget {
  ...
  ///
  /// Each item should be a [VNLMenuItem] or similar menu component.
...
class _DropdownMenuState extends State<VNLDropdownMenu> {
  ...
  Widget build(BuildContext context) {
    ...
    return ConstrainedBox(
      ...
      child: VNLMenuGroup(
        regionGroupId: Data.maybeOf<VNLDropdownMenuData>(context)?.key,
