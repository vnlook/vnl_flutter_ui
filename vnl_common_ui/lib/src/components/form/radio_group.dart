...
/// Theme data for customizing [VNLRadio] widget appearance.
///
/// This class defines the visual properties that can be applied to
/// [VNLRadio] widgets, including colors for different states and sizing.
...
class VNLRadioTheme extends ComponentThemeData {
  ...
  /// - [size] (`double?`, optional): VNLRadio button size.
  const VNLRadioTheme(
...
///
/// [VNLRadio] provides a visual representation of a selectable option within
...
class VNLRadio extends StatelessWidget {
  ...
  /// Creates a [VNLRadio] with the specified selection state and styling.
  ///
...
///   child: Column(
///     children: [
///       VNLRadio<String>(value: 'small', label: Text('Small')),
///       VNLRadio<String>(value: 'medium', label: Text('Medium')),
///       VNLRadio<String>(value: 'large', label: Text('Large')),
///     ],
///   ),
/// )
/// ```
...
class ControlledRadioGroup<T> extends StatelessWidget
  ...
  /// [VNLRadio] widgets. The radio group will manage the selection state
  ...
  ///   child: Column(
  ///     children: [
  ///       VNLRadio<String>(value: 'option1', label: Text('Option 1')),
  ///       VNLRadio<String>(value: 'option2', label: Text('Option 2')),
  ///     ],
  ///   ),
  /// )
  /// ```
