...
///
/// **Work in VNLProgress** - This component is under active development and
...
///     VNLFileItem(file: file, onRemove: () => _removeFile(file))
///   ).toList(),
/// )
/// ```
...
///
/// [VNLFileItem] displays information about a selected or uploaded file including
...
/// )
/// ```
class VNLFileItem extends StatelessWidget {
