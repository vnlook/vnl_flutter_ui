...
class _ColorPickerState extends State<ColorPicker> {
  ...
  VNLColorDerivative get _effectiveValue {
    return _changingValue ?? widget.value;
  }

  void _onChanging(VNLColorDerivative value) {
    setState(() {
  ...
  void _onChanged(VNLColorDerivative value) {
    setState(() {
      _changingValue = null;
      ...
      child: Row(
        ...
        children: [
            ...
            VNLIconButton.outline(
              ...
              onPressed: onEyeDropperRequested ??
                  () async {
                    ...
                    if (result != null) {
                      onChanged?.call(VNLColorDerivative.fromColor(result));
                      if (context.mounted) {
          ...
          if (showHistoryButton)
            VNLIconButton(
              variance:
                  showHistory ? VNLButtonVariance.primary : VNLButtonVariance.outline,
              icon: Icon(
    ...
    return [
      ...
      SizedBox(
        ...
        child: _ColorValueInput(
          ...
          inputFormatters: [
            VNLTextInputFormatters.integerOnly(min: 0, max: 255),
          ],
        ),
      ),
      SizedBox(
    ...
    return [
      SizedBox(
        ...
        child: _ColorValueInput(
          ...
          inputFormatters: [
            VNLTextInputFormatters.integerOnly(min: 0, max: 360),
          ],
        ),
      ),
      SizedBox(
    ...
    return [
      SizedBox(
        ...
        child: _ColorValueInput(
          ...
          inputFormatters: [
            VNLTextInputFormatters.hex(hashPrefix: true),
          ],
        ),
      ),
      if (showAlpha)
