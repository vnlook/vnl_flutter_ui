...
import '../animation.dart' show VNLIntervalDuration;

/// Theme configuration for [VNLCheckbox] widget styling and visual appearance.
///
...
class VNLCheckboxTheme extends ComponentThemeData {
  ...
  bool operator ==(Object other) {
    ...
    return other is VNLCheckboxTheme &&
...
///
/// The controller can be used with [VNLControlledCheckbox] for reactive state
...
///   print('VNLCheckbox is now: ${controller.value}');
/// });
///
...
class VNLCheckboxController extends ValueNotifier<CheckboxState>
  ...
  VNLCheckboxController(super.value);
...
/// [VNLCheckboxController] for programmatic control or with callback-based
/// state management.
///
...
class VNLControlledCheckbox extends StatelessWidget
  ...
  @override
  final VNLCheckboxController? controller;
  ...
  /// Creates a [VNLControlledCheckbox].
  ///
...
/// - **VNLForm integration**: automatic form field registration and validation support
/// - **Layout flexibility**: leading/trailing widgets with automatic styling
///
/// For most use cases, consider [VNLControlledCheckbox] which provides higher-level
...
class VNLCheckbox extends StatefulWidget {
  ...
  @override
  State<VNLCheckbox> createState() => _CheckboxState();
}
                    ...
                    child: AnimatedContainer(
                      ...
                      child: SizedBox(
                        ...
                        child: AnimatedValueBuilder(
                          ...
                          curve: const VNLIntervalDuration(
...
///
/// Used internally by [VNLCheckbox] - not typically instantiated directly by consumers.
class VNLAnimatedCheckPainter extends CustomPainter {
  ...
  /// Creates an [VNLAnimatedCheckPainter].
  ///
  ...
  @override
  bool shouldRepaint(covariant VNLAnimatedCheckPainter oldDelegate) {
