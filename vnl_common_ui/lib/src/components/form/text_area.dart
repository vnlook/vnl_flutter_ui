...
///
/// [VNLTextArea] provides an enhanced text editing experience with support for
...
/// );
/// ```
class VNLTextArea extends TextInputStatefulWidget {
  ...
  /// Creates a [VNLTextArea] with comprehensive configuration options.
  ///
