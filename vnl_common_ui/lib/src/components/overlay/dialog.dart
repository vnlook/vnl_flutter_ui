...
/// ComponentThemeData(
///   data: {
///     ModalBackdropTheme: VNLModalBackdropTheme(
...
/// )
/// ```
class VNLModalBackdropTheme extends ComponentThemeData {
  ...
  /// Creates a [VNLModalBackdropTheme].
  ///
  ...
  ///
  /// Returns:
  /// A new [VNLModalBackdropTheme] with updated values.
  ///
  /// Example:
  /// ```dart
  /// final newTheme = theme.copyWith(
  ///   barrierColor: () => VNLColors.red.withOpacity(0.3),
  ///   modal: () => false,
  /// );
  /// ```
  VNLModalBackdropTheme copyWith({
  ...
  bool operator ==(Object other) {
    return other is VNLModalBackdropTheme &&
...
/// )
/// ```
class VNLModalBackdrop extends StatelessWidget {
  ...
  ///   child: VNLAlertDialog(title: Text('VNLAlert')),
  /// )
  /// ```
  const VNLModalBackdrop({
    super.key,
    this.modal,
    this.surfaceClip,
    this.borderRadius,
  ...
  Widget build(BuildContext context) {
    ...
    Widget paintWidget = CustomPaint(
      painter: VNLSurfaceBarrierPainter(
        clip: surfaceClip,
...
///
/// Wraps modal content in a [VNLSurfaceCard] with appropriate styling that
...
/// )
/// ```
class VNLModalContainer extends StatelessWidget {
...
/// )
/// ```
class VNLSurfaceBarrierPainter extends CustomPainter {
  ...
  /// Creates a [VNLSurfaceBarrierPainter].
  ///
  /// Parameters:
  ...
  @override
  bool shouldRepaint(covariant VNLSurfaceBarrierPainter oldDelegate) {
...
Widget _buildShadcnDialogTransitions(
  ...
  return FocusScope(
    child: fullScreen
        ? MultiModel(
            data: const [
              Model(VNLModalContainer.kFullScreenMode, true),
            ],
...
/// Example:
/// ```dart
/// const VNLDialogOverlayHandler().show<String>(
///   context: context,
///   alignment: Alignment.center,
///   builder: (context) => MyCustomDialog(),
/// );
/// ```
class VNLDialogOverlayHandler extends VNLOverlayHandler {
  ...
  /// Creates a [VNLDialogOverlayHandler].
  ///
  /// Example:
  /// ```dart
  /// const VNLDialogOverlayHandler()
  /// ```
  const VNLDialogOverlayHandler();
  @override
...
///
/// Similar to [VNLDialogOverlayHandler] but specifically designed for full-screen
...
/// Example:
/// ```dart
/// const VNLFullScreenDialogOverlayHandler().show<bool>(
///   context: context,
///   alignment: Alignment.center,
///   builder: (context) => FullScreenForm(),
/// );
/// ```
class VNLFullScreenDialogOverlayHandler extends VNLOverlayHandler {
  /// Checks if the current context is within a dialog overlay.
  ///
  /// Returns `true` if the context is inside a dialog managed by
  /// this overlay handler.
  ...
  /// Creates a [VNLFullScreenDialogOverlayHandler].
  ///
  /// Example:
  /// ```dart
  /// const VNLFullScreenDialogOverlayHandler()
  /// ```
  const VNLFullScreenDialogOverlayHandler();
  @override
  OverlayCompleter<T> show<T>({
