...
///   children: [
///     Container(color: VNLColors.red, child: Center(child: Text('Page 1'))),
///     Container(color: VNLColors.blue, child: Center(child: Text('Page 2'))),
///     Container(color: VNLColors.green, child: Center(child: Text('Page 3'))),
///   ],
/// );
/// ```
