...
class VNLNavigationGap extends StatelessWidget {
  ...
  const VNLNavigationGap(this.gap, {super.key});
...
class VNLNavigationDivider extends StatelessWidget {
  ...
  /// - [color] (Color?): VNLDivider color
  const VNLNavigationDivider({super.key, this.thickness, this.color});
...
class NavigationGroup extends StatelessWidget {
  ...
  Widget buildLabelChild(BuildContext context, VNLNavigationControlData? data) {
  ...
  Widget buildSliverLabelChild(
      BuildContext context, VNLNavigationControlData? data) {
    final theme = Theme.of(context);
    final scaling = theme.scaling;
  ...
  Widget buildBox(BuildContext context, VNLNavigationControlData? data) {
    final theme = Theme.of(context);
    final scaling = theme.scaling;
    final densityContentPadding = theme.density.baseContentPadding * scaling;
  ...
  Widget buildSliver(BuildContext context, VNLNavigationControlData? data) {
    final theme = Theme.of(context);
    final scaling = theme.scaling;
...
/// )
/// ```
class VNLNavigationWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var data = Data.maybeOf<VNLNavigationControlData>(context);
    var key = this.key;
    ...
    if (data?.parentLabelType == NavigationLabelType.tooltip) {
      if (title is! SizedBox) {
        ...
        button = VNLTooltip(
          ...
          tooltip: VNLTooltipContainer(child: title).call,
          child: button,
        );
      }
    }
