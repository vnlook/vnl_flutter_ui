...
/// with full-width items and extensive labeling support. Unlike [VNLNavigationRail],
...
class VNLNavigationSidebar extends StatefulWidget {
  ...
  /// VNLLabel display behavior for navigation items.
  ///
  ...
  /// Creates a [VNLNavigationSidebar] with the specified configuration and items.
  ///
  /// Parameters:
