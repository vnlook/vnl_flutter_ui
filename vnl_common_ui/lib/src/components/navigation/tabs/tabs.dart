...
/// Theme data for customizing [VNLTabs] widget appearance.
///
/// This class defines the visual properties that can be applied to
/// [VNLTabs] widgets, including padding for the container and individual tabs,
...
class VNLTabsTheme extends ComponentThemeData {
  ...
  ///
  /// Returns a new [VNLTabsTheme] with updated values.
  VNLTabsTheme copyWith({
...
///
/// [VNLTabs] provides a clean and intuitive way to organize related content into
