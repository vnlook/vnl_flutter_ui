...
class TabPane<T> extends StatefulWidget {
  ...
  ///   leading: [VNLIconButton(icon: Icon(Icons.add), onPressed: newDocument)],
  ///   trailing: [VNLIconButton(icon: Icon(Icons.settings), onPressed: showSettings)],
  ///   itemBuilder: (context, item, index) => TabChild(
  ///     child: Row(
  ///       children: [
  ///         Text(item.data.title),
  ///         VNLIconButton(icon: Icon(Icons.close), onPressed: () => closeTab(index)),
  ///       ],
  ///     ),
  ///   ),
