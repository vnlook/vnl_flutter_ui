...
/// Theme configuration for [VNLTabList] appearance and behavior.
///
...
///     borderWidth: 2.0,
///     indicatorColor: VNLColors.blue,
///     indicatorHeight: 3.0,
///   ),
///   child: VNLTabList(...),
/// )
/// ```
class VNLTabListTheme extends ComponentThemeData {
  ...
  bool operator ==(Object other) {
    ...
    return other is VNLTabListTheme &&
...
///
/// VNLTabList provides a classic tab interface with a horizontal row of tab buttons
...
/// - Integration with VNLTabContainer for coordinated tab management
///
/// The VNLTabList works as part of a complete tab system, typically used with
...
class VNLTabList extends StatelessWidget {
  ...
  /// Creates a [VNLTabList] with horizontal tab selection.
  ///
