...
/// - VNLForm fields in keyboard-navigable forms
...
///         color: state.isFocused ? VNLColors.blue : VNLColors.transparent,
///         border: Border.all(
///           color: state.isFocused ? VNLColors.blue : VNLColors.grey,
///         ),
///       ),
///       child: Text(
///         'Focusable Item',
///         style: TextStyle(
///           color: state.isFocused ? VNLColors.white : VNLColors.black,
///         ),
///       ),
///     ),
///   ),
