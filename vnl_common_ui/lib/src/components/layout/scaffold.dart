...
/// - VNLProgress indication through [loadingProgress]
...
class VNLScaffoldBarData {
  ...
  /// Creates [VNLScaffoldBarData].
  const VNLScaffoldBarData({
    this.isHeader = true,
                ...
                Widget child = (widget.resizeToAvoidBottomInset ??
                    ...
                    ? Container(
                        ...
                        child: MediaQuery(
                          ...
                          child: VNLToastLayer(child: widget.child),
                        ),
                      )
                    : VNLToastLayer(child: widget.child);
                if (constraints is VNLScaffoldBoxConstraints &&
...
class VNLScaffoldPaddingStorage {
  /// Top padding value.
  double top;
  ...
  /// Creates a [VNLScaffoldPaddingStorage].
  ///
  /// Parameters:
...
class VNLScaffoldBoxConstraints extends BoxConstraints {
  ...
  /// Creates [VNLScaffoldBoxConstraints] from existing [BoxConstraints].
  ///
  /// Parameters:
  ...
  /// - [footerHeight] (`double`, required): Footer height.
  ///
  /// Returns: New [VNLScaffoldBoxConstraints] with scaffold-specific data.
  factory VNLScaffoldBoxConstraints.fromBoxConstraints({
    required BoxConstraints constraints,
    required double headerHeight,
    required double footerHeight,
  }) {
    return VNLScaffoldBoxConstraints(
  ...
  @override
  VNLScaffoldBoxConstraints copyWith({
    double? headerHeight,
    double? footerHeight,
    double? minWidth,
    double? maxWidth,
  ...
  bool operator ==(Object other) {
    ...
    if (other is! VNLScaffoldBoxConstraints) return false;
  ...
  @override
  String toString() {
    return 'VNLScaffoldBoxConstraints(headerHeight: $headerHeight, footerHeight: $footerHeight, minWidth: $minWidth, maxWidth: $maxWidth, minHeight: $minHeight, maxHeight: $maxHeight)';
  }
}
...
///   trailing: [
///     VNLIconButton(icon: Icon(Icons.search), onPressed: _openSearch),
///     VNLIconButton(icon: Icon(Icons.more_vert), onPressed: _showMenu),
///   ],
...
class AppBar extends StatefulWidget {
  ...
  ///   title: Text('Settings'),
  ///   trailing: [
  ///     VNLIconButton(icon: Icon(Icons.help), onPressed: _showHelp),
...
class _AppBarState extends State<AppBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final barData = Data.maybeOf<VNLScaffoldBarData>(context);
...
class _ScaffoldRenderFlex extends RenderBox
  ...
  void performLayout() {
    ...
    content.layout(
      VNLScaffoldBoxConstraints.fromBoxConstraints(
...
class VNLScaffoldHeaderPadding extends SingleChildRenderObjectWidget {
  /// Creates [VNLScaffoldHeaderPadding].
  const VNLScaffoldHeaderPadding({super.key, super.child});
...
class VNLScaffoldFooterPadding extends SingleChildRenderObjectWidget {
  /// Creates [VNLScaffoldFooterPadding].
  const VNLScaffoldFooterPadding({super.key, super.child});
