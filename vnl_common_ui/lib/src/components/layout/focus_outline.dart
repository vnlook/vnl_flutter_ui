...
/// has keyboard focus. Used by [VNLFocusOutline] to apply consistent focus
/// visualization across the application.
class VNLFocusOutlineTheme extends ComponentThemeData {
  ...
  /// Creates a [VNLFocusOutlineTheme].
  ///
  /// Parameters:
  ...
  ///
  /// Returns: A new [VNLFocusOutlineTheme] with updated properties.
  VNLFocusOutlineTheme copyWith({
    ValueGetter<Border?>? border,
    ValueGetter<double?>? align,
    ValueGetter<BorderRadiusGeometry?>? borderRadius,
  }) {
    return VNLFocusOutlineTheme(
  ...
  bool operator ==(Object other) {
    ...
    return other is VNLFocusOutlineTheme &&
        other.align == align &&
        other.border == border &&
...
///   child: VNLTextButton(
///     onPressed: () {},
///     child: Text('Focused VNLButton'),
///   ),
/// )
/// ```
class VNLFocusOutline extends StatelessWidget {
  ...
  ///
  /// If `null`, uses the default from [VNLFocusOutlineTheme].
  final BorderRadiusGeometry? borderRadius;
