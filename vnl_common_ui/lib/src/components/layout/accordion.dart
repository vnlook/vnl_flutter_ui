...
///
/// [VNLAccordion] implements the classic accordion UI pattern where clicking on one item
...
/// - **Theming**: Comprehensive theming via [VNLAccordionTheme]
///
/// ## Usage Pattern
/// An accordion consists of multiple [VNLAccordionItem] widgets, each containing:
/// - [VNLAccordionTrigger]: The clickable header that shows/hides content
...
/// );
/// ```
class VNLAccordion extends StatefulWidget {
  /// The list of accordion items to display.
  ///
  /// Each item should be an [VNLAccordionItem] widget containing a trigger and content.
  ...
  /// Creates an [VNLAccordion] widget with the specified items.
  ///
  /// Parameters:
  /// - [items] (`List<Widget>`, required): List of [VNLAccordionItem] widgets to display.
  ///
...
/// Theme configuration for [VNLAccordion], [VNLAccordionItem], and [VNLAccordionTrigger] widgets.
///
/// [VNLAccordionTheme] provides comprehensive styling options for all accordion-related
...
///     arrowIconColor: VNLColors.blue,
///   ),
///   child: MyAccordionWidget(),
/// );
/// ```
class VNLAccordionTheme extends ComponentThemeData {
  ...
  /// Creates an [VNLAccordionTheme] with the specified styling options.
  ///
  ...
  @override
  String toString() {
    return 'VNLAccordionTheme(duration: $duration, curve: $curve, reverseCurve: $reverseCurve, padding: $padding, iconGap: $iconGap, dividerHeight: $dividerHeight, dividerColor: $dividerColor, arrowIcon: $arrowIcon, arrorIconColor: $arrowIconColor)';
  }
}

/// An individual item within an [VNLAccordion] that can be expanded or collapsed.
///
/// [VNLAccordionItem] represents a single section within an accordion, containing
/// both a trigger (the clickable header) and the collapsible content area. It
/// manages its own animation state and coordinates with the parent [VNLAccordion]
...
/// );
/// ```
class VNLAccordionItem extends StatefulWidget {
  /// The clickable header widget that controls expansion.
  ///
  /// Typically an [VNLAccordionTrigger] widget, but can be any widget that
  ...
  /// Creates an [VNLAccordionItem] with the specified trigger and content.
  ///
  /// Parameters:
  ...
  ///
  /// The item automatically integrates with its parent [VNLAccordion] to provide
  ...
  @override
  State<VNLAccordionItem> createState() => _AccordionItemState();
}

class _AccordionItemState extends State<VNLAccordionItem>
...
/// A specialized trigger widget designed for use within [VNLAccordionItem].
///
/// [VNLAccordionTrigger] provides a consistent, accessible interface for accordion
/// headers. It automatically includes:
/// - VNLHover effects with text underlining
/// - Focus management with keyboard navigation
/// - Animated expand/collapse icon
/// - Proper click and keyboard activation
/// - Accessibility semantics
///
/// The trigger automatically coordinates with its parent [VNLAccordionItem] to
...
/// );
/// ```
class VNLAccordionTrigger extends StatefulWidget {
  ...
  /// Creates an [VNLAccordionTrigger] with the specified child content.
  ///
  /// Parameters:
  ...
  /// - Animated expand/collapse icon
  /// - Integration with parent [VNLAccordionItem] state
  ///
  /// Example:
  /// ```dart
  /// VNLAccordionTrigger(
  ...
  /// );
  /// ```
  const VNLAccordionTrigger({super.key, required this.child});

  @override
  State<VNLAccordionTrigger> createState() => _AccordionTriggerState();
}

class _AccordionTriggerState extends State<VNLAccordionTrigger> {
