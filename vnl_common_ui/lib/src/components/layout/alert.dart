...
/// Theme configuration for [VNLAlert] components.
///
...
class VNLAlertTheme extends ComponentThemeData {
  ...
  /// Applied to the [VNLOutlinedContainer] that wraps the alert content.
  final Color? backgroundColor;

  /// The border color of the alert outline.
  ///
  /// Type: `Color?`. If null, uses the default border color from [VNLOutlinedContainer].
  ...
  ///   borderColor: VNLColors.blueAccent,
  /// );
  /// ```
  const VNLAlertTheme({this.padding, this.backgroundColor, this.borderColor});
  ...
  /// );
  /// ```
  VNLAlertTheme copyWith({
    ValueGetter<EdgeInsetsGeometry?>? padding,
    ValueGetter<Color?>? backgroundColor,
    ValueGetter<Color?>? borderColor,
  }) {
    return VNLAlertTheme(
...
///
/// The VNLAlert widget provides a flexible layout for presenting information to users
...
///
/// The component uses a [VNLBasic] layout internally and wraps content in an
/// [VNLOutlinedContainer] for consistent visual presentation. Text and icon colors
...
class VNLAlert extends StatelessWidget {
  ...
  /// Creates an [VNLAlert] with standard styling.
  ///
  ...
  /// Creates an [VNLAlert] with destructive styling pre-configured.
  ///
