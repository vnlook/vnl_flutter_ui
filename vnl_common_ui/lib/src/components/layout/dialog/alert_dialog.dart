...
///
/// VNLAlertDialog provides a focused overlay interface for critical user interactions
/// that require immediate attention or confirmation. Built on top of [VNLModalBackdrop]
/// and [VNLModalContainer], it ensures proper accessibility and visual hierarchy.
///
...
///   actions: [
///     VNLButton.ghost(onPressed: () => Navigator.pop(context), child: Text('Cancel')),
///     VNLButton.destructive(onPressed: _deleteItem, child: Text('Delete')),
///   ],
/// );
/// ```
class VNLAlertDialog extends StatefulWidget {
  ...
  ///   actions: [
  ///     VNLTextButton(onPressed: () => Navigator.pop(context), child: Text('Cancel')),
  ...
  @override
  State<VNLAlertDialog> createState() => _AlertDialogState();
}
...
class _AlertDialogState extends State<VNLAlertDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return VNLModalBackdrop(
      ...
      surfaceClip: VNLModalBackdrop.shouldClipSurface(
