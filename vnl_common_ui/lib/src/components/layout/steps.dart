...
/// Theme for [VNLSteps].
class VNLStepsTheme extends ComponentThemeData {
...
///
/// Typically used as children within [VNLSteps] to create a multi-step
/// process visualization. Displays a title in bold followed by content items.
///
/// Example:
/// ```dart
/// VNLStepItem(
///   title: Text('VNLStep Title'),
///   content: [
///     Text('VNLStep description'),
///     Text('Additional details'),
///   ],
/// )
/// ```
class VNLStepItem extends StatelessWidget {
