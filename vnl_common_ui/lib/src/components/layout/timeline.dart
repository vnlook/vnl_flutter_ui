...
/// Theme configuration for [VNLTimeline] widgets.
///
...
/// );
/// ```
class VNLTimelineTheme extends ComponentThemeData {
  /// Default constraints for the time column width.
  ///
  /// Controls the minimum and maximum width allocated for displaying time
  /// information in each timeline row. If null, individual VNLTimeline widgets
  ...
  /// individual [VNLTimelineData] entries don't specify their own color.
  final Color? color;
  ...
  bool operator ==(Object other) {
    ...
    return other is VNLTimelineTheme &&
...
/// Used by [VNLTimeline] to construct the visual timeline representation.
///
/// Example:
/// ```dart
/// VNLTimelineData(
...
class VNLTimelineData {
  ...
  /// Creates a [VNLTimelineData] entry for use in [VNLTimeline] widgets.
  ///
  /// Parameters:
...
///
/// [VNLTimeline] creates a structured vertical layout showing a sequence of events
/// or data points with time information, titles, optional content, and visual
/// indicators. Each entry is represented by a [VNLTimelineData] object and displayed
...
class VNLTimeline extends StatelessWidget {
  ...
  ///
  /// Each [VNLTimelineData] object represents one row in the timeline with
  ...
  final List<VNLTimelineData> data;
  ...
  /// Creates a [VNLTimeline] widget with the specified data entries.
  ///
  /// Parameters:
  /// - [data] (`List<VNLTimelineData>`, required): VNLTimeline entries to display in order.
