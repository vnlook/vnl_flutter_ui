...
/// Theme data for customizing [VNLCard] and [VNLSurfaceCard] widget appearance.
///
...
class VNLCardTheme extends ComponentThemeData {
...
///
/// [VNLCard] is a foundational layout component that wraps content in a visually distinct
...
/// VNLCard(
///   filled: true,
///   fillColor: VNLColors.white,
///   borderRadius: BorderRadius.circular(12),
///   boxShadow: [
///     BoxShadow(
///       color: VNLColors.black.withOpacity(0.1),
///       blurRadius: 8,
///       offset: Offset(0, 2),
///     ),
///   ],
...
///     child: Column(
///       children: [
///         Text('VNLCard Title', style: TextStyle(fontWeight: FontWeight.bold)),
///         SizedBox(height: 8),
///         Text('VNLCard content goes here...'),
///       ],
///     ),
///   ),
/// );
...
///
/// Similar to [VNLCard] but with enhanced visual effects including frosted glass
...
/// )
/// ```
class VNLSurfaceCard extends StatelessWidget {
  /// The child widget to display within the card.
  final Widget child;
  ...
  /// Creates a [VNLSurfaceCard].
  const VNLSurfaceCard({
    super.key,
    required this.child,
    this.padding,
    this.filled,
