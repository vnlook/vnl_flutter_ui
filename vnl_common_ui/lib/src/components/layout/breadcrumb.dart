...
/// Theme for [VNLBreadcrumb].
class VNLBreadcrumbTheme extends ComponentThemeData {
  ...
  const VNLBreadcrumbTheme({this.separator, this.padding});

  /// Returns a copy of this theme with the given fields replaced.
  VNLBreadcrumbTheme copyWith({
    ValueGetter<Widget?>? separator,
    ValueGetter<EdgeInsetsGeometry?>? padding,
  }) {
    return VNLBreadcrumbTheme(
  ...
  bool operator ==(Object other) {
    ...
    return other is VNLBreadcrumbTheme &&
...
class VNLBreadcrumb extends StatelessWidget {
  ...
  /// Creates a [VNLBreadcrumb] navigation trail.
  ///
  ...
  ///   children: [
  ///     VNLTextButton(onPressed: goHome, child: Text('Home')),
  ///     VNLTextButton(onPressed: goToCategory, child: Text('Category')),
  ///     Text('Current Page'),
  ///   ],
  /// )
  /// ```
