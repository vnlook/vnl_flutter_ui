...
/// Theme configuration for [VNLAvatar] and related avatar components.
///
...
///     size: 48.0,
///     borderRadius: 8.0,
///     backgroundColor: VNLColors.grey.shade200,
///     badgeAlignment: Alignment.topRight,
///     textStyle: TextStyle(color: VNLColors.black, fontWeight: FontWeight.w600),
///   ),
///   child: MyAvatarWidget(),
/// );
/// ```
class VNLAvatarTheme extends ComponentThemeData {
  ...
  ///   size: () => 60.0,
  ///   backgroundColor: () => VNLColors.blue.shade100,
  /// );
  /// ```
  VNLAvatarTheme copyWith({
  ...
  bool operator ==(Object other) {
    ...
    return other is VNLAvatarTheme &&
        other.size == size &&
...
///
/// [VNLAvatarWidget] provides a common interface for avatar components, ensuring
/// they expose size and border radius properties that can be used by container
/// components like [VNLAvatarGroup] for proper layout and clipping.
abstract class VNLAvatarWidget extends Widget {
  /// Creates an [VNLAvatarWidget] with optional key.
  const VNLAvatarWidget({super.key});
...
///
/// [VNLAvatar] provides a versatile component for representing users in UI interfaces.
...
/// optional badges for status indicators and integrates seamlessly with [VNLAvatarGroup]
...
/// - **Group Integration**: Works with [VNLAvatarGroup] for overlapping layouts
///
/// ## Initials Generation
...
///   size: 48,
///   backgroundColor: VNLColors.blue.shade100,
///   badge: VNLAvatarBadge(
///     color: VNLColors.green,
///     size: 12,
///   ),
/// );
/// ```
class VNLAvatar extends StatefulWidget implements VNLAvatarWidget {
  ...
  /// Example:
  /// ```dart
  /// String initials1 = VNLAvatar.getInitials('John Doe'); // Returns 'JD'
  /// String initials2 = VNLAvatar.getInitials('Madonna'); // Returns 'MA'
  /// ```
  ...
  ///
  /// Type: `VNLAvatarWidget?`. Typically an [VNLAvatarBadge] for status indicators.
  /// Positioned according to [badgeAlignment] with [badgeGap] spacing.
  final VNLAvatarWidget? badge;
  ...
  /// Creates an [VNLAvatar] widget with optional image provider.
  ///
  ...
  ///   If null, defaults to theme.radius * size for proportional rounding.
  /// - [badge] (VNLAvatarWidget?, optional): Optional badge overlay for status
  ...
  ///   size: 48,
  ///   backgroundColor: VNLColors.blue.shade100,
  ///   badge: VNLAvatarBadge(color: VNLColors.green),
  /// );
  /// ```
  const VNLAvatar({
    super.key,
  ...
  /// Creates an [VNLAvatar] with a network image.
  ///
  ...
  /// - [size] (double?, optional): VNLAvatar dimensions in logical pixels.
  /// - [borderRadius] (double?, optional): Corner radius in logical pixels.
  /// - [badge] (VNLAvatarWidget?, optional): Optional badge overlay.
  ...
  @override
  State<VNLAvatar> createState() => _AvatarState();
}
...
/// A circular badge widget designed to overlay on [VNLAvatar] components.
///
/// [VNLAvatarBadge] provides a small circular indicator typically used to show
...
///   size: 16,
///   color: VNLColors.green,
///   child: Icon(Icons.check, size: 10, color: VNLColors.white),
/// );
/// ```
class VNLAvatarBadge extends StatelessWidget implements VNLAvatarWidget {
  ...
  /// VNLAvatarBadge(
  ///   color: VNLColors.red,
  ///   child: Text('5', style: TextStyle(color: VNLColors.white, fontSize: 8)),
  /// );
  /// ```
  const VNLAvatarBadge({
    super.key,
    this.child,
    this.size,
    this.borderRadius,
...
class _AvatarWidget extends StatelessWidget implements VNLAvatarWidget {
  @override
  final double? size;
  @override
  final double? borderRadius;
...
/// A widget that arranges multiple [VNLAvatarWidget]s in an overlapping layout.
///
/// [VNLAvatarGroup] creates visually appealing overlapping arrangements of avatars,
...
/// Example:
/// ```dart
/// VNLAvatarGroup.toRight(
///   children: [
///     VNLAvatar(initials: 'AB'),
///     VNLAvatar(initials: 'CD'),
///     VNLAvatar(initials: 'EF'),
///   ],
///   gap: 8.0,
/// );
/// ```
class VNLAvatarGroup extends StatelessWidget {
  ...
  final List<VNLAvatarWidget> children;
  ...
  /// Creates an [VNLAvatarGroup] with custom alignment.
  ///
  ...
  /// - [children] (`List<VNLAvatarWidget>`, required): Avatars to arrange
  ...
  ///   children: [VNLAvatar(initials: 'A'), VNLAvatar(initials: 'B')],
  ///   gap: 6.0,
  /// );
  /// ```
  const VNLAvatarGroup({
    super.key,
  ...
  /// Creates an [VNLAvatarGroup] with left-to-right overlapping.
  ///
  ...
  /// Example:
  /// ```dart
  /// VNLAvatarGroup.toLeft(
  ///   children: [VNLAvatar(initials: 'A'), VNLAvatar(initials: 'B')],
  ///   offset: 0.7,
  /// );
  /// ```
  factory VNLAvatarGroup.toLeft({
    Key? key,
    required List<VNLAvatarWidget> children,
    double? gap,
    double offset = 0.5,
  }) {
    return VNLAvatarGroup(
  ...
  /// Creates an [VNLAvatarGroup] with right-to-left overlapping.
  ///
  ...
  /// );
  /// ```
  factory VNLAvatarGroup.toRight({
    Key? key,
    required List<VNLAvatarWidget> children,
    double? gap,
    double offset = 0.5,
  ...
  /// Creates an [VNLAvatarGroup] with start-to-end overlapping.
  ///
  ...
  /// Example:
  /// ```dart
  /// VNLAvatarGroup.toStart(
  ///   children: [VNLAvatar(initials: 'A'), VNLAvatar(initials: 'B')],
  /// );
  /// ```
  factory VNLAvatarGroup.toStart({
    Key? key,
    required List<VNLAvatarWidget> children,
    double? gap,
    double offset = 0.5,
  ...
  /// Creates an [VNLAvatarGroup] with end-to-start overlapping.
  ///
  ...
  /// Example:
  /// ```dart
  /// VNLAvatarGroup.toEnd(
  ///   children: [VNLAvatar(initials: 'A'), VNLAvatar(initials: 'B')],
  /// );
  /// ```
  factory VNLAvatarGroup.toEnd({
    Key? key,
    required List<VNLAvatarWidget> children,
    double? gap,
    double offset = 0.5,
  ...
  /// Creates an [VNLAvatarGroup] with top-to-bottom overlapping.
  ///
  ...
  /// Example:
  /// ```dart
  /// VNLAvatarGroup.toTop(
  ///   children: [VNLAvatar(initials: 'A'), VNLAvatar(initials: 'B')],
  /// );
  /// ```
  factory VNLAvatarGroup.toTop({
    Key? key,
    required List<VNLAvatarWidget> children,
    double? gap,
    double offset = 0.5,
  ...
  /// Creates an [VNLAvatarGroup] with bottom-to-top overlapping.
  ///
  ...
  /// Example:
  /// ```dart
  /// VNLAvatarGroup.toBottom(
  ///   children: [VNLAvatar(initials: 'A'), VNLAvatar(initials: 'B')],
  /// );
  /// ```
  factory VNLAvatarGroup.toBottom({
    Key? key,
    required List<VNLAvatarWidget> children,
    double? gap,
    double offset = 0.5,
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < this.children.length; i++) {
      VNLAvatarWidget avatar = this.children[i];
...
class VNLAvatarGroupClipper extends CustomClipper<Path> {
  ...
  @override
  bool shouldReclip(covariant VNLAvatarGroupClipper oldClipper) {
