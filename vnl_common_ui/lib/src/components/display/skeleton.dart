...
class ShadcnSkeletonizerConfigLayer extends StatelessWidget {
  ...
  /// - [enableSwitchAnimation] (bool?, optional): VNLSwitch animation behavior override
  ///
  /// Example:
  /// ```dart
  /// ShadcnSkeletonizerConfigLayer(
...
///
/// Methods automatically detect certain widget types (VNLAvatar, Image) and apply
...
extension SkeletonExtension on Widget {
  ...
  ///
  /// Special handling:
  /// - VNLAvatar and Image widgets use [Skeleton.leaf] to avoid rendering issues
  ...
  ///     onPressed: () {},
  ///     child: Text('Cancel'),
  ///   ).ignoreSkeleton(), // VNLButton remains interactive
  /// ]).asSkeleton();
  /// ```
