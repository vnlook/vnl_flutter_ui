...
/// Theme configuration for [VNLCodeSnippet] components.
///
...
/// );
/// ```
class VNLCodeSnippetTheme extends ComponentThemeData {
  ...
  /// ```dart
  /// VNLCodeSnippetTheme(
  ///   backgroundColor: VNLColors.black87,
  ///   borderRadius: BorderRadius.circular(12.0),
  ///   padding: EdgeInsets.all(20.0),
  /// );
  /// ```
  const VNLCodeSnippetTheme({
  ...
  bool operator ==(Object other) {
    ...
    return other is VNLCodeSnippetTheme &&
...
///
/// [VNLCodeSnippet] provides a professional code display component with automatic
...
/// );
/// ```
class VNLCodeSnippet extends StatefulWidget {
  ...
  /// Creates a [VNLCodeSnippet] widget.
  ///
  ...
  @override
  State<VNLCodeSnippet> createState() => _CodeSnippetState();
}

class _CodeSnippetState extends State<VNLCodeSnippet> {
  ...
  // @override
  // void didUpdateWidget(covariant VNLCodeSnippet oldWidget) {
