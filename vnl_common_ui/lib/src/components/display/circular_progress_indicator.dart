...
/// Theme configuration for [VNLCircularProgressIndicator] components.
///
...
class VNLCircularProgressIndicatorTheme extends ComponentThemeData {
  ...
  /// Example:
  /// ```dart
  /// const VNLCircularProgressIndicatorTheme(
  ...
  VNLCircularProgressIndicatorTheme copyWith({
    ValueGetter<Color?>? color,
    ValueGetter<Color?>? backgroundColor,
    ValueGetter<double?>? size,
    ValueGetter<double?>? strokeWidth,
  }) {
    return VNLCircularProgressIndicatorTheme(
  ...
  bool operator ==(Object other) {
    ...
    return other is VNLCircularProgressIndicatorTheme &&
        other.color == color &&
...
///
/// The VNLCircularProgressIndicator provides both determinate and indeterminate
...
///
/// Built as a wrapper around Flutter's native VNLCircularProgressIndicator with
...
/// );
/// ```
class VNLCircularProgressIndicator extends StatelessWidget {
  ...
  /// Creates a [VNLCircularProgressIndicator].
  ///
  ...
  /// - [strokeWidth] (double?, optional): VNLProgress stroke thickness override
