...
/// Theme data for [VNLSelectableText] to customize cursor and selection behavior.
/// {@endtemplate}
class VNLSelectableTextTheme extends ComponentThemeData {
  ...
  VNLSelectableTextTheme copyWith({
  ...
  bool operator ==(Object other) {
    ...
    return other is VNLSelectableTextTheme &&
  ...
  @override
  String toString() {
    return 'VNLSelectableTextTheme(cursorWidth: $cursorWidth, cursorHeight: $cursorHeight, cursorRadius: $cursorRadius, cursorColor: $cursorColor, selectionHeightStyle: $selectionHeightStyle, selectionWidthStyle: $selectionWidthStyle, enableInteractiveSelection: $enableInteractiveSelection)';
  }
}
...
/// - [VNLTextField] for editable text input
...
class VNLSelectableText extends StatelessWidget {
  ...
  ///       TextSpan(
  ///         text: 'website',
  ///         style: TextStyle(color: VNLColors.blue, decoration: TextDecoration.underline),
  ///       ),
  ...
  ///
  /// Either [data] or [textSpan] must be non-null, but not both.
  /// Used when constructing with the [VNLSelectableText.rich] constructor.
