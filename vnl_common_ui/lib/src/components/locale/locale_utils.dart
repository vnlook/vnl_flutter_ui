...
const _fileByteUnits =
    VNLSizeUnitLocale(1024, ['B', 'KB', 'MB', 'GB', 'TB', 'PB', 'EB', 'ZB', 'YB']);
const _fileBitUnits = VNLSizeUnitLocale(
...
/// - [unit] (`VNLSizeUnitLocale`, required): Unit locale configuration.
///
/// Returns: `String` — formatted file size with unit.
///
/// Example:
/// ```dart
/// formatFileSize(1024, VNLSizeUnitLocale.fileBytes) // "1 KB"
/// formatFileSize(1536, VNLSizeUnitLocale.fileBytes) // "1.5 KB"
/// ```
String formatFileSize(int bytes, VNLSizeUnitLocale unit) {
