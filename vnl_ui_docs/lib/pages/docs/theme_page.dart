...
const List<_AccentOption> _accentOptions = [
  ...
  _AccentOption(id: 'slate', label: 'Slate', color: VNLColors.slate),
  _AccentOption(id: 'gray', label: 'Gray', color: VNLColors.gray),
  _AccentOption(id: 'zinc', label: 'Zinc', color: VNLColors.zinc),
  _AccentOption(id: 'neutral', label: 'Neutral', color: VNLColors.neutral),
  _AccentOption(id: 'stone', label: 'Stone', color: VNLColors.stone),
  _AccentOption(id: 'red', label: 'Red', color: VNLColors.red),
  _AccentOption(id: 'orange', label: 'Orange', color: VNLColors.orange),
  _AccentOption(id: 'amber', label: 'Amber', color: VNLColors.amber),
  _AccentOption(id: 'yellow', label: 'Yellow', color: VNLColors.yellow),
  _AccentOption(id: 'lime', label: 'Lime', color: VNLColors.lime),
  _AccentOption(id: 'green', label: 'Green', color: VNLColors.green),
  _AccentOption(id: 'emerald', label: 'Emerald', color: VNLColors.emerald),
  _AccentOption(id: 'teal', label: 'Teal', color: VNLColors.teal),
  _AccentOption(id: 'cyan', label: 'Cyan', color: VNLColors.cyan),
  _AccentOption(id: 'sky', label: 'Sky', color: VNLColors.sky),
  _AccentOption(id: 'blue', label: 'Blue', color: VNLColors.blue),
  _AccentOption(id: 'indigo', label: 'Indigo', color: VNLColors.indigo),
  _AccentOption(id: 'violet', label: 'Violet', color: VNLColors.violet),
  _AccentOption(id: 'purple', label: 'Purple', color: VNLColors.purple),
  _AccentOption(id: 'fuchsia', label: 'Fuchsia', color: VNLColors.fuchsia),
  _AccentOption(id: 'pink', label: 'Pink', color: VNLColors.pink),
...
class _ThemePageState extends State<ThemePage> {
  ...
  Widget _buildKitchenPreview(BuildContext context) {
    return VNLMediaQueryVisibility(
      minWidth: 1350,
            ...
            children: [
              ...
              Expanded(
                child: VNLTextField(
                  initialValue: '8',
                  inputFormatters: [
                    VNLTextInputFormatters.digitsOnly(min: 0, max: 64),
                  ],
                  features: const [
      ...
      child: Column(
        children: [
          VNLAvatarGroup.toLeft(
            ...
            offset: 0.7,
            children: const [
              VNLAvatar(initials: 'ST'),
              VNLAvatar(initials: 'JS'),
          ...
          child: VNLTextField(
            ...
            features: [
              VNLInputFeature.trailing(
                VNLWidgetStatesProvider.boundary(
                  child: VNLTooltip(
                    tooltip: const VNLTooltipContainer(child: Text('Voice Mode')),
  ...
  Widget _buildKitchenSearch() {
    return VNLTextField(
      ...
      features: [
        VNLInputFeature.leading(const Icon(Icons.search).iconMutedForeground),
        VNLInputFeature.trailing(const Text('12 Results').muted.small.medium),
      ],
    );
  }
  ...
  Widget _buildKitchenURL() {
    return VNLTextField(
      ...
      features: [
        VNLInputFeature.leading(const Text('https://').muted.small.medium),
        VNLInputFeature.hint(
            popupBuilder: const VNLTooltipContainer(
  ...
  Widget _buildKitchenAIChat() {
    return VNLTextField(
      ...
      features: [
        VNLInputFeature.below(VNLWidgetStatesProvider.boundary(
          child: Padding(
  ...
  Color _baseSwatchColor(String baseId) {
    switch (baseId) {
      case 'slate':
        return VNLColors.slate.shade600;
      case 'zinc':
        return VNLColors.zinc.shade600;
      case 'gray':
        return VNLColors.gray.shade500;
      case 'neutral':
        return VNLColors.neutral.shade600;
      case 'stone':
        return VNLColors.stone.shade600;
      default:
        return VNLColors.slate.shade600;
    }
  }
